...
INSTRUCTIONS = [
    ...
    Instruction(r'\I8X16.\SHUFFLE~\laneidx^{16}', r'\hex{FD}~~13', r'[\V128~\V128] \to [\V128]', r'valid-simd-shuffle', r'exec-simd-shuffle'),
    ...
    Instruction(r'\I16X8.\NARROW\K{\_i32x4\_s}', r'\hex{FD}~~133', r'[\V128~\V128] \to [\V128]', r'valid-vbinop', r'exec-simd-narrow'),
    Instruction(r'\I16X8.\NARROW\K{\_i32x4\_u}', r'\hex{FD}~~134', r'[\V128~\V128] \to [\V128]', r'valid-vbinop', r'exec-simd-narrow'),
    ...
    Instruction(r'\F32X4.\VSQRT', r'\hex{FD}~~227', r'[\V128] \to [\V128]', r'valid-vunop', r'exec-vunop', r'op-fsqrt'),
    ...
    Instruction(r'\F64X2.\VSQRT', r'\hex{FD}~~239', r'[\V128] \to [\V128]', r'valid-vunop', r'exec-vunop', r'op-fsqrt'),
