...
let encode m =
  ...
  let module E = struct
    ...
    let rec instr e =
      ...
      | SimdLoadLane ({ty= V128Type; sz = Some (Pack8, laneidx); _} as mo) ->
          simd_op 0x58l; memop mo; u8 laneidx;
      | SimdLoadLane ({ty= V128Type; sz = Some (Pack16, laneidx); _} as mo) ->
          simd_op 0x59l; memop mo; u8 laneidx;
      | SimdLoadLane ({ty= V128Type; sz = Some (Pack32, laneidx); _} as mo) ->
          simd_op 0x5al; memop mo; u8 laneidx;
      | SimdLoadLane ({ty= V128Type; sz = Some (Pack64, laneidx); _} as mo) ->
