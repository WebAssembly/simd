...
let i8x16_extract_lane_s imm = ExtractLane (V128Op.I8x16 (SX, imm))
let i8x16_extract_lane_u imm = ExtractLane (V128Op.I8x16 (ZX, imm))
...
let i16x8_extract_lane_s imm = ExtractLane (V128Op.I16x8 (SX, imm))
let i16x8_extract_lane_u imm = ExtractLane (V128Op.I16x8 (ZX, imm))
...
let i32x4_extract_lane imm = ExtractLane (V128Op.I32x4 (ZX, imm))
...
let i64x2_extract_lane imm = ExtractLane (V128Op.I64x2 (ZX, imm))
...
let f32x4_extract_lane imm = ExtractLane (V128Op.F32x4 (ZX, imm))
...
let f64x2_extract_lane imm = ExtractLane (V128Op.F64x2 (ZX, imm))
