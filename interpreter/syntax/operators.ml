...
let i8x16_shl = Shift V128Op.(I8x16 Shl)
let i8x16_shr_s = Shift V128Op.(I8x16 ShrS)
...
let i16x8_shl = Shift V128Op.(I16x8 Shl)
let i16x8_shr_s = Shift V128Op.(I16x8 ShrS)
...
let i32x4_shl = Shift V128Op.(I32x4 Shl)
let i32x4_shr_s = Shift V128Op.(I32x4 ShrS)
...
let i64x2_shl = Shift V128Op.(I64x2 Shl)
let i64x2_shr_s = Shift V128Op.(I64x2 ShrS)
