...
let i8x16_splat = Splat (V128Op.I8x16 V128Op.Splat)
let i16x8_splat = Splat (V128Op.I16x8 V128Op.Splat)
let i32x4_splat = Splat (V128Op.I32x4 V128Op.Splat)
let i64x2_splat = Splat (V128Op.I64x2 V128Op.Splat)
let f32x4_splat = Splat (V128Op.F32x4 V128Op.Splat)
let f64x2_splat = Splat (V128Op.F64x2 V128Op.Splat)
