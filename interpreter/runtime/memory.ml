...
let load_simd_lane v pack_size mem a o t laneidx =
  ...
  | Pack8 -> V128 (V128.I8x16.replace_lane laneidx v (Int64.to_int32 x))
  | Pack16 -> V128 (V128.I16x8.replace_lane laneidx v (Int64.to_int32 x))
  | Pack32 -> V128 (V128.I32x4.replace_lane laneidx v (Int64.to_int32 x))
  | Pack64 -> V128 (V128.I64x2.replace_lane laneidx v x)
