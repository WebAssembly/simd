...
| `i8x16.all_true`          |    `0x53`| -                  |
| `i8x16.add`               |    `0x54`| -                  |
| `i8x16.add_saturate_s`    |    `0x55`| -                  |
| `i8x16.add_saturate_u`    |    `0x56`| -                  |
| `i8x16.sub`               |    `0x57`| -                  |
| `i8x16.sub_saturate_s`    |    `0x58`| -                  |
| `i8x16.sub_saturate_u`    |    `0x59`| -                  |
| `i8x16.mul`               |    `0x5a`| -                  |
| `i8x16.shl`               |    `0x5f`| -                  |
| `i8x16.shr_s`             |    `0x60`| -                  |
| `i8x16.shr_u`             |    `0x61`| -                  |
...
| `i16x8.all_true`          |    `0x64`| -                  |
| `i16x8.add`               |    `0x65`| -                  |
| `i16x8.add_saturate_s`    |    `0x66`| -                  |
| `i16x8.add_saturate_u`    |    `0x67`| -                  |
| `i16x8.sub`               |    `0x68`| -                  |
| `i16x8.sub_saturate_s`    |    `0x69`| -                  |
| `i16x8.sub_saturate_u`    |    `0x6a`| -                  |
| `i16x8.mul`               |    `0x6b`| -                  |
| `i16x8.shl`               |    `0x70`| -                  |
| `i16x8.shr_s`             |    `0x71`| -                  |
| `i16x8.shr_u`             |    `0x72`| -                  |
