...
| `i16x8.load8x8_u`          |    `0xc6`| m:memarg           |
| `i16x8.load8x8_s`          |    `0xc7`| m:memarg           |
| `i32x4.load16x4_u`         |    `0xc8`| m:memarg           |
| `i32x4.load16x4_s`         |    `0xc9`| m:memarg           |
| `i64x2.load32x2_u`         |    `0xca`| m:memarg           |
| `i64x2.load32x2_s`         |    `0xcb`| m:memarg           |
| `i8x16.narrow_i16x8_s`     |    `0xcc`| -                  |
| `i8x16.narrow_i16x8_u`     |    `0xcd`| -                  |
| `i16x8.narrow_i32x4_s`     |    `0xce`| -                  |
| `i16x8.narrow_i32x4_u`     |    `0xcf`| -                  |
| `i16x8.widen_low_i8x16_s`  |    `0xd0`| -                  |
| `i16x8.widen_high_i8x16_s` |    `0xd1`| -                  |
| `i16x8.widen_low_i8x16_u`  |    `0xd2`| -                  |
| `i16x8.widen_high_i8x16_u` |    `0xd3`| -                  |
| `i32x4.widen_low_i16x8_s`  |    `0xd4`| -                  |
| `i32x4.widen_high_i16x8_s` |    `0xd5`| -                  |
| `i32x4.widen_low_i16x8_u`  |    `0xd6`| -                  |
| `i32x4.widen_high_i16x8_u` |    `0xd7`| -                  |
