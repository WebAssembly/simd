...
| `i8x16.convert_s/i16x8`     |    `0xc6`| -                  |
| `i8x16.convert_u/i16x8`     |    `0xc7`| -                  |
| `i16x8.convert_s/i32x4`     |    `0xc8`| -                  |
| `i16x8.convert_u/i32x4`     |    `0xc9`| -                  |
| `i16x8.convert_s/i8x16Low`  |    `0xca`| -                  |
| `i16x8.convert_s/i8x16High` |    `0xcb`| -                  |
| `i16x8.convert_u/i8x16Low`  |    `0xcc`| -                  |
| `i16x8.convert_u/i8x16High` |    `0xcd`| -                  |
| `i32x4.convert_s/i16x8Low`  |    `0xce`| -                  |
| `i32x4.convert_s/i16x8High` |    `0xcf`| -                  |
| `i32x4.convert_u/i16x8Low`  |    `0xd0`| -                  |
| `i32x4.convert_u/i16x8High` |    `0xd1`| -                  |
