...
| `f32x4.sqrt`              |      142 | -                  |
| `f64x2.sqrt`              |      143 | -                  |
| `f32x4.convert_s/i32x4`   |      144 | -                  |
| `f32x4.convert_u/i32x4`   |      145 | -                  |
| `f64x2.convert_s/i64x2`   |      146 | -                  |
| `f64x2.convert_u/i64x2`   |      147 | -                  |
| `i32x4.trunc_s/f32x4:sat` |      148 | -                  |
| `i32x4.trunc_u/f32x4:sat` |      149 | -                  |
| `i64x2.trunc_s/f64x2:sat` |      150 | -                  |
| `i64x2.trunc_u/f64x2:sat` |      151 | -                  |
