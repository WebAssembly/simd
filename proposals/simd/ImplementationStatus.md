...
[3] Not known to be updated after latest renumbering. Requires flag `--enable
simd`

[4] Not known to be updated after latest renumbering. Requires
(case-insensitive) flag `-wasmsimd`

[5] Firefox Nightly x64/x86 SSE4.1+ only, disable in about:config under
